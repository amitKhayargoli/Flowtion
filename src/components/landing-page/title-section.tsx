...
const TitleSection : React.FC<TitleSectionProps> = ({
  ...
  return (
    <React.Fragment>
        ...
        <article className='rounded-full p-[1px] text-sm dark:bg-gradient-to-r dark:from-[#0f172a] dark:to-[#1e293b] bg-gradient-to-r from-[#f8fafc] to-[#e2e8f0]'>
    ...
    {subheading ? (
        ...
        <p className='dark:text-white sm:max-w-[450px] md:text-center'></p>
        </>) : (
